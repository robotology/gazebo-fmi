...
void FMIActuatorPluginKnownInputTest::PluginTest(const std::string &_physicsEngine)
{
  ...
  // Without the FMU trasmission, the PID loop should work fine
...
INSTANTIATE_TEST_CASE_P(PhysicsEngines, FMIActuatorPluginKnownInputTest, /*PHYSICS_ENGINE_VALUES*/ ::testing::Values("ode"));
